...
for filename in ["src/components/VimEditor.tsx", "src/components/AuxiliaryKeyboard.tsx"]:
    ...
    old_code = """const isTouchDevice = typeof window !== 'undefined' && (('ontouchstart' in window) || (navigator.maxTouchPoints > 0) || /Mobi|Android|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent || ''));"""
